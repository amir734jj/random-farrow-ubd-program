/* The following code was generated by JFlex 1.5.0-SNAPSHOT (+scala) on 2/2/26, 11:22 AM */

/**
 * This class is a scanner generated by
 * <a href="http://www.jflex.de/">JFlex</a> 1.5.0-SNAPSHOT (+scala)
 * on 2/2/26, 11:22 AM from the specification file
 * <tt>FarrowUbd.lex</tt>
 */
class FarrowUbdScanner(private var zzReader : java.io.Reader) extends Iterator[FarrowUbdTokens.YYToken] {
  ...
  private def zzUnpackAction() : Array[Int] =  {
    val result:Array[Int] = new Array[Int](14);
    var offset:Int = 0;
  ...
  private def zzUnpackTrans() : Array[Int] =  {
    val result:Array[Int] = new Array[Int](90);
    var offset:Int = 0;
   ...
   */
  def yylex() : FarrowUbdTokens.YYToken =
  {
    var zzInput : Int = 0;
    var zzAction : Int = 0;
